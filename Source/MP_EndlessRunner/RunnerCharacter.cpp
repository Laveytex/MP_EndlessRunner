...
ARunnerCharacter::ARunnerCharacter()
{
	...
	CharViewCamera = CreateDefaultSubobject<UCameraComponent>(TEXT("Side View Camera"));
	CharViewCamera->bUsePawnControlRotation = false;
...
void ARunnerCharacter::Tick(float DeltaTime)
{
	...
	tempPos.X -= 850.0f;
	tempPos.Z = zPosition;
	CharViewCamera->SetWorldLocation(tempPos);
}
...
UCameraComponent* ARunnerCharacter::GetCharViuwCamera()
{
